...
class Attention2d(nn.Module):
    ...
    def forward(self, pair_act, attention_mask, bias=None):
        ...
        l = bias.size(-1)
        bn = nn.BatchNorm2d(l).cuda()
        pos_weight_normalized = bn(bias.view(batch_size, l, l, 1)).view(batch_size, 1, 1, l, l)

        modified_attn_weights = attn_weights * pos_weight_normalized
